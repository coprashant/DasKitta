...
const IPOApply = () => {
  ...
  /* accounts card shared between mobile and desktop */
  const AccountsCard = (
      <div className="card anim-fade-up" style={{ animationDelay: "0.12s" }}>
        <div className="ipo-accounts-head">
          ...
          {/* expandable search sits between label and select all */}
          {accounts.length > 3 && (
              ...
              <>
                <div className="ipo-layout">
                  ...
                  <div className="ipo-col">
                    ...
                    {/* kitta below IPOs on desktop only */}
                  ...
                  <div className="ipo-col">
                    {/* accounts on mobile come after IPOs, before kitta via order */}
                    <div className="ipo-accounts-wrapper">
                      {AccountsCard}
                    </div>

                    {/* kitta below accounts on mobile only */}
